...
Present
\Gap
Currently working on backend systems, using Java and Python to create Docker-backed microservices and deploying them with Spinnaker and Kubernetes to AWS; I've worked extensively with other parts of AWS (e.g. S3, SNS/SQS, Route 53) as part of our backend. Responsible for designing several core components of the architecture, writing according automated tests, and overseeing the deployments through from dev to production.
\newline
...
\textbf{Technologies/Applications:} Ansible, AWS, Gradle, Helm, Git, Mercurial, Hibernate, Jenkins, 
Linux, Cassandra, SQL, Swagger/OpenAPI, Kubernetes, Terraform \newline
\end{flushleft}
